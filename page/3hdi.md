...
ブログ記事<i class="fa fa-external-link" aria-hidden="true"></i>: [4D Write Pro: キャリーオーバー行を導入]([support.apple.com](https://blog.4d.com/ja/4d-write-pro-carry-over-rows-are-available/)
