...
* ACI0101383 フォームエディターでヘルプTipsの参照を更新しても変更が保存されませんでした。
...
* ACI0101051 Windows版のみ。フォームエディターのテキストエリアに``Alt``キーを数字のコンビネーションでアクセント文字を入力することができませんでした。メソッドエディターでは問題ありません。
