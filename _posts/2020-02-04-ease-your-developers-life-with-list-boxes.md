...
Employeeのlastnameを表示するカラムのヘッダーをクリックした際に、lastnema<strong>とfirstname</strong>属性のカラムをソートします：
...
<span class="notranslate variable">$0</span>:=<span class="notranslate variable">$meta</span></code>
